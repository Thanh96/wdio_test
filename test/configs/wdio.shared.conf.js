// Take a screenshot of when the Test failed. Do not delete these lines below.
const fs = require("fs");
...
exports.config = {
  ...
  // suites             : {
  //   smoketest: [
  //     "./tests/specs/admin-dashboard.spec.js",
  //   ],
  // },
  // Because of the way the organization runs, it's always a good idea
  ...
  afterTest(test, context, { error }) {
    ...
    if (error) {
      ...
      const it = test.description.split(":")[0];

      browser.saveScreenshot(path.join(dir, `${spec}_${it}.png`));
    }
  },
  /**
  ...
  //   console.log("Running Time in : " + runningTime + "s");
  //   if (runningTime < 10) {
  //     console.warn("DM CHAY CHAM NHU RUA");
   ...
   */
  // afterStep: function(oldSessionId, newSessionId) {
  // }
